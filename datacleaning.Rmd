...
data_dictionary <- data.frame(
  ...
  Cleaning_Steps = c(
    "Converted to factor; NA values dropped.",
    "Converted to numeric hours; NA values dropped.",
    "Converted to numeric hours; NA values dropped.",
    "Standardised to 'Yes'/'No'; NA values dropped.",
    "Standardised to 'Yes'/'No'; NA values dropped.",
    "Recoded into 'Active' / 'Passive'; NA values dropped.",
    "Converted to numeric year level; NA values dropped.",
    "Kept as free-text factor; NA values dropped.",
    "Converted to numeric count; NA values dropped.",
    "Converted to numeric count; NA values dropped.",
    "Standardised country names; NA values dropped.",
    "Recoded to ordered factor (Pass < Credit < Distinction < High Distinction); NA values dropped.",
    "Responses grouped into categories: 'Start early', 'Steady pace', 'Last minute'; NA values dropped.",
    "Standardised to 'Trimester' or 'Semester'; NA values dropped.",
    "Converted to numeric age; NA values dropped.",
    "Recoded to 'Yes' / 'No' tendency; NA values dropped.",
    "Standardised to 'Yes' / 'No'; NA values dropped.",
    "Recoded into factor levels: 'First', 'Middle', 'Last'; NA values dropped.",
    "Converted to numeric count of Weet-Bix; NA values dropped.",
    "Converted to numeric AUD dollars per week; NA values dropped."
  ),
