...
df_cleaned <- df %>%
  mutate(
    ...
    `What is your favourite anime?` = str_trim(`What is your favourite anime?`),  # Open text, stripped whitespace
    
    # Discrete and numerical fields
    ...
    # Binary and multiple category fields
