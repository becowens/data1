...
df <- read_excel("./exceldata2902.xlsx")
...
Cleaning_Steps = c(
  ...
  "Lowercased, punctuation removed, whitespace trimmed, country names standardised (e.g., 'usa', 'australia', 'uk', 'new zealand', 'vietnam'); only top 10 responses kept, others grouped as 'Other'; NA values dropped; unused levels removed.",
...
```
```{r}
saveRDS(finaldf, file = "clean_data.rds") 
```
